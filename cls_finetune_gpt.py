...
if __name__ == '__main__':
    ...
    DATASET = 'optc' if args.optc else 'unsw' else \
    ...
    if args.model_fname: 
        ...
        OUT_F = f'{HOME}/{DATASET}/{RAND}{"static" if not args.trw else "rwft"}{bi_fname}_results_{FNAME}_{SIZE}_wl{WALK_LEN}{args.tag}.txt'
